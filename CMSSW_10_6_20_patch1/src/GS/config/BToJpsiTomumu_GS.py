...
# with command line options: Configuration/GenProduction/python/BToJpsiTomumu.py --fileout file:BToJpsiTomumu_GS.root --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions 106X_mc2017_realistic_v8 --beamspot Realistic25ns13TeVEarly2017Collision --step GEN,SIM --customise Configuration/DataProcessing/Utils.addMonitoring --geometry DB:Extended --era Run2_2017 --python_filename BToJpsiTomumu_GS.py -n 1 --no_exec
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:BToJpsiTomumu_GS.root'),
